...
public class SysRoleServiceImpl extends ServiceImpl<SysRoleMapper, SysRole> implements ISysRoleService
{
    ...
    public List<SysRole> selectRoleList(SysRole role)
    {
        ...
        return list(new LambdaQueryWrapper<SysRole>()
                ...
                .eq(role.getRoleId()!=null, SysRole::getRoleId, role.getRoleId())
                ...
                .ge(params.get("beginTime")!=null, SysRole::getCreateTime, params.get("beginTime"))
                .le(params.get("endTime")!=null, SysRole::getCreateTime, params.get("endTime"))
